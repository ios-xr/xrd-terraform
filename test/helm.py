...
class Helm:
    ...
    def repo_add(
        self, name: str, url: str, *, force_update: bool = False
    ) -> list[str]:
        args = [name, url]
    ...
    def install(
        ...
        *,
        ...
        wait: bool = False,
        **kwargs,
    ) -> Generator[list[str], subprocess.CompletedProcess, Release]:
        """
    ...
    ) -> Generator[list[str], subprocess.CompletedProcess, list[Release]]:
        args = ["--output", "json"]
